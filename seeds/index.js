...
async function main() {
  await mongoose.connect(
    'mongodb+srv://kiyoko:mongodb1018@cluster0.zduqs.mongodb.net/yelp-camp2'
  );
...
const seedDB = async () => {
  ...
  for (let i = 0; i < 300; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus, quidem blanditiis distinctio beatae a perferendis consectetur hic officiis dolorem optio ex ducimus tempora?',
